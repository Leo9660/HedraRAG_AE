...
struct IndexIVF : Index, IndexIVFInterface {
    ...
    void search_preassigned(
     ...
     void search_preassigned_heterag_omp(
        idx_t n,
        const float* x,
        idx_t k,
        const idx_t* assign,
    ...
    //heterag
    void search_preassigned_heterag(
            idx_t n,
            const float* x,
            idx_t k,
            const idx_t* assign,
        ...
        void search_preassigned_heterag_nprobe(
                idx_t n,
                const float* x,
                idx_t k,
                const idx_t* keys,
...
struct InvertedListScanner {
    ...
    virtual size_t scan_codes_heterag(
            size_t n,
            const uint8_t* codes,
            const idx_t* ids,
            float* distances,
