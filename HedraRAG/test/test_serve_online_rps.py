...
def main():
    ...
    import argparse
    import time
    from heterag import Config, SequentialRAGraph, get_dataset, Request
    from heterag.executor.executor import HeteragExecutor
    ...
    for rps in rps_list:
        ...
        if args.write_file is not None:
            with open(args.write_file, 'a+', newline='') as f:
                writer = csv.writer(f)
                writer.writerow(["HedraRAG", args.rag_workflow, args.nprobe, rps, average_query_latency])
