def main():
    ...
    from heterag import Config, HeteragExecutor, SequentialRAGraph, get_dataset, SequentialExecutor
    import numpy as np
    import faiss
    import argparse
    import time
    ...
    if args.write_file is not None:
        with open(args.write_file, 'a+', newline='') as f:
            writer = csv.writer(f)
            writer.writerow(["FlashRAG", args.rag_workflow, args.data_dir, args.nprobe, args.nprobe_minibatch, average_query_latency, loop_time])
